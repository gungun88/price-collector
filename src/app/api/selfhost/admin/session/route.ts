...
export async function GET(request: Request) {
  try {
    ...
    const response = await fetch(selfHostedApiUrl("/api/admin/session"), {
    ...
    return Response.json(
      { ok: false, authenticated: false, message: error instanceof Error ? error.message : "Self-hosted admin session failed." },
