  ...
  return (
    <>
      <div className="sticky top-0 z-40 border-b border-white/10 bg-[#050505]/95 backdrop-blur-xl">
        <SiteHeader activeSection="api" maxWidthClassName="max-w-[1500px]" variant="dark" />
        <CategoryTabBar
          items={familyTabs}
          value={family}
      ...
      <main className="mx-auto max-w-[1500px] px-5 pb-6 pt-3 sm:px-8 md:pb-10 md:pt-4 lg:pb-12 lg:pt-5">
